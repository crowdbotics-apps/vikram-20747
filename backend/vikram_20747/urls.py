"""vikram_20747 URL Configuration
...
admin.site.site_header = "vikram"
admin.site.site_title = "vikram Admin Portal"
admin.site.index_title = "vikram Admin"

# swagger
api_info = openapi.Info(
    title="vikram API",
    default_version="v1",
    description="API documentation for vikram App",
)
